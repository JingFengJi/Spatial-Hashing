...
{
    public class SpatialHashSphereQueryDemo : MonoBehaviour, IRay
    {
        ...
        [SerializeField]
        private Transform m_SphereQueryTransform;
        
        [SerializeField]
        private float m_SphereQueryRadius = 10F;
        
        private NativeList<ItemTest> m_QueryResults;
        ...
        private void Start()
        {
            ...
            m_QueryResults = new NativeList<ItemTest>(32, Allocator.Persistent);
        ...
        private void Update()
        {
            ...
            _spatialHashing.SphereQuery(m_SphereQueryTransform.position, m_SphereQueryRadius, m_QueryResults);
            Profiler.EndSample();
        }
        ...
        private void OnDrawGizmos()
        {
            ...
            if (_DrawQueryResultGizmos)
            {
                ...
                Gizmos.DrawSphere(m_SphereQueryTransform.position, m_SphereQueryRadius);
                
                for (int i = 0; i < m_QueryResults.Length; i++)
                {
                    Gizmos.color = new Color(0F, 1F, 0F, 1F); 
                    Gizmos.DrawCube(m_QueryResults[i].GetCenter(), m_QueryResults[i].GetSize());
                }
            }
        }
